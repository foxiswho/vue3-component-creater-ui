...
// 以这样一段结构初始化VCC组件
const initCodeStr = '{"template":{"lc_id":"root","__children":[{"div":{"class":"container","style":"min-height: 100%; padding-bottom: 100px;","lc_id":"container","__text__":"","__children":[{"el-form":{":model":"formFox",":rules":"rulesFox","ref":"formFox","lc-mark":"","label-width":"100px","class":"demo-border","lc_id":"duihphjqis","fox-components-type":"form","__children":[{"el-form-item":{"label":"标题","prop":"name","lc-mark":"","lc_id":"n7xh7xcozm","fox-components-type":"form-item","__children":[{"el-input":{"v-model":"formFox.name","lc_id":"6mycyzkhag","__children":[]}}]}}]}}]}}]}}'
